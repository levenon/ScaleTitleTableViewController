...
@property (nonatomic, assign) BOOL allowsSelection;     // default is YES. Controls whether rows can be selected.
@property (nonatomic, assign) BOOL allowsMultipleSelection; // default is NO. Controls whether multiple rows can be selected simultaneously
@property (nonatomic, assign) MMHorizontalListViewPosition autoScrollPosition;
...
/**
 *  Method to updated did-selected cell and will-selected cell in progress.
 *
 *  @param index index
 *  @param progress 0 - 1
 */
